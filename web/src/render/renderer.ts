/**
 * WebGL2 renderer. Everything is instanced: one draw call each for seed
 * patches, seeds, vision wedges, birds and the selection ring, all reading
 * straight from the packed frame buffer the worker sent. Five draw calls for
 * ten thousand things, every frame, at any zoom.
 */
